package org.pixelbays.rpg.party.finder.command;
...
public class PartyFinderCommand extends AbstractPlayerCommand {

    public PartyFinderCommand() {
        super("finder", "Open the party group finder UI");
