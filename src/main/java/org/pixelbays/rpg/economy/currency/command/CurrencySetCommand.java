...
public class CurrencySetCommand extends AbstractPlayerCommand {
    ...
    public CurrencySetCommand() {
        super("set", "Set your currency balance");
    ...
    protected void execute(@Nonnull CommandContext ctx,
        ...
        if (scope == null) {
            player.sendMessage(Message.translation("pixelbays.rpg.currency.usage.set"));
            return;
        }
        ...
        CurrencyActionResult result = currencyManager.setBalance(scope, ownerId, currencyId, amount.longValue());
