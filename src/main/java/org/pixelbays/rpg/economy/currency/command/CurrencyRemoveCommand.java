...
public class CurrencyRemoveCommand extends AbstractPlayerCommand {
    ...
    public CurrencyRemoveCommand() {
        super("remove", "Remove currency from yourself");
    ...
    protected void execute(@Nonnull CommandContext ctx,
        ...
        if (scope == null) {
            player.sendMessage(Message.translation("pixelbays.rpg.currency.usage.remove"));
            return;
        }
        ...
        CurrencyActionResult result = currencyManager.removeBalance(scope, ownerId, currencyId, amount.longValue());
