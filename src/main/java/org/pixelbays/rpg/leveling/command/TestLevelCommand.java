...
public class TestLevelCommand extends AbstractPlayerCommand {
    ...
    protected void execute(@Nonnull CommandContext commandContext,
         ...
         * levelSystem.grantExperience(ref, "character_level", 150f, "test", store,
         * world);
         * 
         * LevelProgressionComponent levelComp = store.getComponent(ref,
         * ExamplePlugin.get().getLevelProgressionComponentType());
         * LevelProgressionComponent.LevelSystemData charData =
         * levelComp.getSystem("character_level");
         ...
         * ));
         * levelSystem.grantExperience(ref, "character_level", 2000f, "test", store,
         * world);
         * 
         * // Refetch component to get updated data
         * levelComp = store.getComponent(ref,
         * ExamplePlugin.get().getLevelProgressionComponentType());
         * charData = levelComp.getSystem("character_level");
         * player.sendMessage(Message.raw("Now level " + charData.getCurrentLevel() +
         * " (need 10+ for warrior class)"));
         * 
         ...
         * player.sendMessage(Message.raw("DEBUG: Systems in map: " +
         * levelComp.getAllSystems().keySet()));
         * player.sendMessage(Message.raw("DEBUG: hasSystem(class_warrior): " +
         * levelComp.hasSystem("class_warrior")));
         * 
         * LevelProgressionComponent.LevelSystemData warriorData =
         * levelComp.getSystem("class_warrior");
         * player.sendMessage(Message.raw("DEBUG: warriorData is null: " + (warriorData
         * == null)));
         * 
         * if (warriorData != null) {
         * player.sendMessage(Message.raw("Warrior class initialized at level " +
         * warriorData.getCurrentLevel()));
         * levelSystem.grantExperience(ref, "class_warrior", 300f, "test", store,
         * world);
         * 
         ...
         * player.sendMessage(Message.raw("Warrior level " +
         * warriorData.getCurrentLevel()));
         * } else {
         * player.sendMessage(Message.
         * raw("ERROR: warriorData is null but system claims to exist!"));
         * }
         * 
         ...
         * for (java.util.Map.Entry<String, LevelProgressionComponent.LevelSystemData>
         * entry : levelComp.getAllSystems().entrySet()) {
