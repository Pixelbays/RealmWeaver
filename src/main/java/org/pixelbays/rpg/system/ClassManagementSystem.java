...
public class ClassManagementSystem {
    ...
    public String unlearnClass(@Nonnull Ref<EntityStore> entityRef, String classId,
        ...
        ClassAbilityComponent abilityComp = getClassAbilityComponent(entityRef, store);
        if (abilityComp != null) {
    ...
    @Nullable
    private ClassAbilityComponent getClassAbilityComponent(@Nonnull Ref<EntityStore> entityRef,
            @Nonnull Store<EntityStore> store) {
        return store.getComponent(entityRef, ClassAbilityComponent.getComponentType());
    }
