...
public class CharacterTokenGiveCommand extends AbstractPlayerCommand {
    ...
    public CharacterTokenGiveCommand() {
        super("give", "Give character tokens to an online player");
    ...
    protected void execute(@Nonnull CommandContext ctx,
        ...
        CharacterTokenActionResult result = characterManager.addAccountTokenBalance(
                targetRef.getUuid(),
