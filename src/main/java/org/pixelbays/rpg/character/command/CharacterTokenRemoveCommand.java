...
public class CharacterTokenRemoveCommand extends AbstractPlayerCommand {
    ...
    public CharacterTokenRemoveCommand() {
        super("remove", "Remove character tokens from an online player");
    ...
    protected void execute(@Nonnull CommandContext ctx,
        ...
        CharacterTokenActionResult result = characterManager.removeAccountTokenBalance(
                targetRef.getUuid(),
